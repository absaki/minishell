...
/*   Updated: 2021/03/16 18:33:40 by kikeda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static int	dollar_without_parenthesis(char *s, t_sh *sh, char **tmp)
{
	int		i;
	int		end;
	char	*new;
...
static int	dollar_with_parenthesis(char *s, t_sh *sh, char **tmp)
{
	int		i;
	int		end;
	char	*new;
